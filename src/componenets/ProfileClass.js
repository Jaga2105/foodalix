...
class Profile extends React.Component {
  constructor(props) {
    ...
    this.state = {
      userInfo : {
        name : "Dummy Name",
        bio : "Front-End Developer who is passionate about developing end-to-end web solutions with creativity and technical excellence."
      }
    }
  ...
  render() {
    ...
    return (
      <div className="flex flex-col justify-center items-center mt-4 gap-5"> 
        ...
        <div className="">
          <p className="text-base text-bio pt-5 mt-0 mb-4 w-[60%] text-center mx-auto">
            {/* {userInfo.bio} */}
            {`Front-End Developer who is passionate about developing end-to-end web solutions
